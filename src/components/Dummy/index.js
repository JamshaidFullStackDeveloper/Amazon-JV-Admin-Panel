...
const Sidebar = ({ children, isOpen }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            const timer = setTimeout(() => {
                setShowText(true); // Set text to show after 1 second
            }, 400);

            return () => clearTimeout(timer); // Cleanup on unmount or isOpen change
        } else {
            setShowText(false); // Reset text visibility when isOpen is false
        }
    }, [isOpen]);
    ...
    return (
        // <div
        //     className={cn(
        //         " bg-white shadow-lg flex flex-col z-10 transition-all duration-1000 ease-in-out relative rounded-lg border-2 mt-4 ",
        ...
        //     {/* Sidebar Header */}
        //     <div
        //         className={`flex gap-2 justify-center items-center ${isOpen ? "p-3" : "p-1"
        //             } border-b border-gray-200 ${isOpen ? "m-4" : "m-1"} border-2 rounded-lg`}
        //     >
        //         <CompanyLogo />
        //         {isOpen && (
        //             <div className={cn(
        //                 "flex flex-col gap-0 transition-all duration-1000 ease-in-out",
        ...
        //     <div
        //         className={cn(
        //             "cursor-pointer absolute top-28 z-50 transition-all duration-1000 ease-in-out",
        //             isOpen ? "right-[-15px]" : "right-[-1px]",
        //             isOpen ? "top-28" : "top-14"
        //         )}
        ...
        //                 href={item.link}
        //                 className={cn(
        //                     "flex items-center gap-3  rounded-lg text-gray-600 hover:bg-[#1A77F8] hover:text-white transition-all duration-100 ease-in-out",
        //                     isOpen ? "p-1" : "p-2",
        //                     !isOpen && "justify-center",
        //                     // Add active class based on the current location
        ...
        //                 <div
        //                     className={cn(
        //                         "flex items-center justify-between p-2 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition cursor-pointer",
        //                         !isOpen && "justify-center"
        //                     )}
        ...
        //                             <ChevronDownIcon
        //                                 className={`w-4 h-4 transition-transform ${activeDropdown === index ? "rotate-180" : "rotate-0"
        //                                     }`}
        //                             />
        //                         </>
        //                     ) : (
        //                         <span className="text-center">{product.name[0]}</span>
        //                     )}
        //                 </div>
        ...
        //             href="/logout"
        //             className={cn(
        //                 "flex items-center gap-3 p-2 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition",
        //                 !isOpen && "justify-center"
        //             )}
        //         >
        //             <span>Logout</span>
